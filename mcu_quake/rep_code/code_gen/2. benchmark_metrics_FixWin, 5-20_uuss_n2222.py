...
if __name__ == "__main__":
    ...
    # Menggunakan os.path.join untuk keamanan path di macOS
    key_data_dir = "/Volumes/Local Disk/Code_Git/S3_code/seismic/mcu_quake/Benchmark_ UUSS 3C_ test n2222 r100"

    """ UUSS dataset """ 
    DATA_TAG = "UUSS"
    # Nama file JSON yang sudah terverifikasi ada di folder tersebut
    key_test_file = "UUSS 3C data, test n2222 r100.json" 
    true_labels = ["NO", "QB", "LE"]

    # Path folder Typical Embedding
