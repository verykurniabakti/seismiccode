...
# 7 s period records
train_file_path = "Data train-demo\\UUSS Train demo dataset.pkl"   # only 256 samples
val_file_path= "Data train-demo\\UUSS Validation demo dataset.pkl" # only 256 samples
